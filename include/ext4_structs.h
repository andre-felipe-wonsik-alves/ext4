...
/*
Ao usar o pack, mapeamos os bytes físicos diretamente na memória do C++ e
impedimos o compilador de otimizar algumas questões de acesso de memória
(inserindo padding entre os campos da struct, precisamente); isso foi feito para
conseguirmos acessar a memória de maneira contígua.
*/
#pragma pack(push, 1)
struct super_block {
